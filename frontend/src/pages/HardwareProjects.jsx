...
export default function HardwareProjects() {
    ...
    const [form, setForm] = useState({ id: null, title: '', description: '', category: 'Hardware', githubLink: '', demoLink: '', techStack: '', image_url: '' });
    ...
    const fetchProjects = async () => {
        const { data } = await supabase.from('projects').select('*').eq('category', 'Hardware').order('id', { ascending: false });
        if (data) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            fetchProjects();
            setShowModal(false);
            setForm({ id: null, title: '', description: '', category: 'Hardware', githubLink: '', demoLink: '', techStack: '', image_url: '' });
            setImageFile(null);
        } catch (err) {
            console.error(err);
        }
